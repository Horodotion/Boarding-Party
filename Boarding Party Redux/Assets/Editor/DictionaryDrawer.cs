...
[CustomPropertyDrawer(typeof(StatDictionary))] // Name of your class (same as above)
public class StatDictionaryDrawer : DictionaryDrawer<string, bool> { } // chose same types as your dictionary
